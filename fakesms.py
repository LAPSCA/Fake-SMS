#bin code Made By niuoten is scritp using to send sms nothing elas 
#if u using my code pls mintion me : ) Thank you for using us my code and tool all love @niuoten
#the Code 
import re
import os
import time
...
def usage1():
    ...
    2. Country Code Example: 91 / 249 / 1 / 967 
